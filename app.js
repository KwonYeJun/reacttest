...
function render(virtualDOM, container) {
  ...
  virtualDOM.props.children.forEach(child => render(child, domElement)); container.appendChild(domElement);
}
...
const App = createElementExample(
  ...
  [
    ...
    createElementExample("p", null, ["020 client-side rendering|CH!"])
  ]
);
